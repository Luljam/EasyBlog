...
namespace EasyBlog.Web.Controllers.API
{
    ...
    public class BlogApiController : ApiController
    {
        ...
        public HttpResponseMessage FetchPosts(HttpRequestMessage request)
        {
            ...
            try
            {
                IBlogPostRepository blogPostRepository = _ComponentLocator.ResolveComponet<IBlogPostRepository>();
        ...
        public HttpResponseMessage SubmitComment(HttpRequestMessage request, [FromBody]BlogComment blogComment)
        {
            ...
            try
            {
                ...
                if (!preArgs.Cancel)
                {
                    IBlogCommentRepository blogCommentRepository = _ComponentLocator.ResolveComponet<IBlogCommentRepository>();
